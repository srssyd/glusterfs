...
{
	STACK_UNWIND_STRICT (rename, frame, -1, op_errno, NULL, NULL, NULL, NULL, NULL, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (mknod, frame, -1, op_errno, NULL, NULL, NULL, NULL, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (create, frame, -1, op_errno, NULL, NULL, NULL, NULL, NULL, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (mkdir, frame, -1, op_errno, NULL, NULL, NULL, NULL, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (symlink, frame, -1, op_errno, NULL, NULL, NULL, NULL, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (link, frame, -1, op_errno, NULL, NULL, NULL, NULL, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (seek, frame, -1, op_errno, -1, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (getspec, frame, op_ret, op_errno,
			     spec_data);
	return 0;
}
...
default_flush_resume (call_frame_t *frame, xlator_t *this, fd_t * fd,
	dict_t * xdata)
{
	STACK_WIND (frame, default_flush_cbk,
...
default_inodelk_resume (call_frame_t *frame, xlator_t *this, const char * volume,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_inodelk_cbk,
...
default_xattrop_resume (call_frame_t *frame, xlator_t *this, loc_t * loc,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_xattrop_cbk,
...
default_finodelk_resume (call_frame_t *frame, xlator_t *this, const char * volume,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_finodelk_cbk,
		    FIRST_CHILD(this), FIRST_CHILD(this)->fops->finodelk,
...
default_lk_resume (call_frame_t *frame, xlator_t *this, fd_t * fd,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_lk_cbk,
...
int32_t
default_symlink_resume (call_frame_t *frame, xlator_t *this, const char * linkpath,
	loc_t * loc,
	mode_t umask,
	dict_t * xdata)
{
...
default_fsyncdir_resume (call_frame_t *frame, xlator_t *this, fd_t * fd,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_fsyncdir_cbk,
		    FIRST_CHILD(this), FIRST_CHILD(this)->fops->fsyncdir,
		    fd, flags, xdata);
	return 0;
}
...
default_fxattrop_resume (call_frame_t *frame, xlator_t *this, fd_t * fd,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_fxattrop_cbk,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_fentrylk_cbk,
		    FIRST_CHILD(this), FIRST_CHILD(this)->fops->fentrylk,
	...
	int32_t flags)
{
	STACK_WIND (frame, default_getspec_cbk,
		    FIRST_CHILD(this), FIRST_CHILD(this)->fops->getspec,
		    key, flags);
	return 0;
}
...
default_setattr_resume (call_frame_t *frame, xlator_t *this, loc_t * loc,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_setattr_cbk,
...
default_fsync_resume (call_frame_t *frame, xlator_t *this, fd_t * fd,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_fsync_cbk,
...
int32_t
default_seek_resume (call_frame_t *frame, xlator_t *this, fd_t * fd,
	off_t offset,
	gf_seek_what_t what,
	dict_t * xdata)
{
	STACK_WIND (frame, default_seek_cbk,
...
default_fsetattr_resume (call_frame_t *frame, xlator_t *this, fd_t * fd,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_fsetattr_cbk,
