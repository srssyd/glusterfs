...
#include "defaults.h"
#include "thpool.h"
#include "../../../../libglusterfs/src/common-utils.h"
#include "../../../../libglusterfs/src/iobuf.h"
#include "../../../../libglusterfs/src/stack.h"
#include <sys/time.h>
...
void *ec_dispatch_batch_mask_single_thread(void * data){
	...
	int32_t ec_fsync_cbk(call_frame_t *frame,void *cookie,xlator_t *this,int32_t op_ret,int32_t op_errno,struct iaat * prebuf,struct iaat* postbuf,dict_t * xdata);
//	if(bufsize == 0)
//		return;
